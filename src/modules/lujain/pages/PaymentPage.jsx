...
export default function PaymentPage({ setPage, refreshNotifs, addNotification, analysisId }) {
  ...
  const handleSuccess = () => {
    ...
    setTimeout(() => { if (refreshNotifs) refreshNotifs(); }, 2000);
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "4.5rem 2rem 6rem" }}>
          <div style={{ textAlign: "center", maxWidth: "650px", margin: "0 auto 3.5rem" }}>
            ...
            <p className="section-sub" style={{ margin: "0 auto" }}>
              Take your AI results to the next level. Our specialized doctors will review your analysis
              and build a precision skincare routine tailored just for you.
            </p>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div className="plan-card featured" style={{ maxWidth: "450px", width: "100%", textAlign: "center" }}>
              ...
              <button className="plan-btn plan-btn-gold" onClick={() => setShowModal(true)}>
                Get My Routine Now
              </button>
