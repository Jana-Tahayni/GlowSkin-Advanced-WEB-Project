...
<head>
  ...
  <title>Reset your password – GlowSkin</title>
  <style>
    ...
    .hero h1 { margin:0; color:#fff; font-size:28px; font-weight:600; letter-spacing:3px; text-transform:uppercase; }
    ...
    .btn     { display:inline-block; padding:14px 36px;
               ...
               border-radius:11px; font-size:14px; font-weight:600; letter-spacing:1px; }
...
<body>
  <div class="wrap">
    ...
    <div class="body">
      ...
      <p>
        We received a request to reset your GlowSkin password.
      ...
      <p class="note">
        ...
        <a href="{{ $resetUrl }}" style="color:#C8896E;word-break:break-all;">{{ $resetUrl }}</a>
      </p>
